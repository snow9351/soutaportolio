...
export function Settings(props: SettingsProps) {
  ...
  const changeBackgroundImage = (e: React.FocusEvent<HTMLDivElement>) => {
    ...
    if (path) props.changeBackgroundImage(path);
  };
  ...
  return (
    ...
    >
      <div
        ...
        style={{
          backgroundImage: `url(${wallpapers[props.currBgImgName as WallpaperKey]})`,
      ...
      <div className="flex flex-wrap justify-center items-center border-t border-gray-900">
        {(Object.keys(wallpapers) as WallpaperKey[]).map((name, index) => (
          <div
            key={index}
            tabIndex={1}
            ...
            className={
              (name === props.currBgImgName
                ? " border-yellow-700 "
                : " border-transparent ") +
              " md:px-28 md:py-20 md:m-4 m-2 px-14 py-10 outline-none border-4"
            }
            style={{
              backgroundImage: `url(${wallpapers[name as WallpaperKey]})`,
              backgroundSize: "cover",
              backgroundRepeat: "no-repeat",
              backgroundPosition: "center center",
            }}
...
export const displaySettings = () => {
  return <Settings changeBackgroundImage={() => {}} currBgImgName="wall-8" />;
};
